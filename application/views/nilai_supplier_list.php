    ...
    <div class='col-xs-12'>
      <div class='box'>
        <div class='box-header'>
          <h3 class='box-title'>NILAI_SUPPLIER LIST <?php echo anchor('nilai_supplier/create/', 'Create', array('class' => 'btn btn-danger btn-sm')); ?>
          ...
          <table class="table table-bordered table-striped" id="mytable">
            <thead>
              <tr>
                <th width="80px">No</th>
                <th>Id Supplier</th>
                <th>Id Jenisbarang</th>
                <th>Id Kriteria</th>
                <th>Id Nilaikriteria</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody>
